...
static const oid socketFamilyOID[] = { DNSDIST_TRAP_OBJECTS_OID, 1 };
static const oid socketProtocolOID[] = { DNSDIST_TRAP_OBJECTS_OID, 2 };
static const oid fromAddressOID[] = { DNSDIST_TRAP_OBJECTS_OID, 3 };
static const oid toAddressOID[] = { DNSDIST_TRAP_OBJECTS_OID, 4 };
static const oid queryTypeOID[] = { DNSDIST_TRAP_OBJECTS_OID, 5 };
static const oid querySizeOID[] = { DNSDIST_TRAP_OBJECTS_OID, 6 };
static const oid queryIDOID[] = { DNSDIST_TRAP_OBJECTS_OID, 7 };
static const oid qNameOID[] = { DNSDIST_TRAP_OBJECTS_OID, 8 };
static const oid qClassOID[] = { DNSDIST_TRAP_OBJECTS_OID, 9 };
static const oid qTypeOID[] = { DNSDIST_TRAP_OBJECTS_OID, 10 };
static const oid trapReasonOID[] = { DNSDIST_TRAP_OBJECTS_OID, 11 };
