...
DNSPacket::DNSPacket(const DNSPacket &orig): d_remote(orig.d_remote), d_dt(orig.d_dt), qtype(orig.qtype), qdomain(orig.qdomain), qdomainwild(orig.qdomainwild), qdomainzone(orig.qdomainzone), d_eso(orig.d_eso), d_tsigkeyname(orig.d_tsigkeyname), d_trc(orig.d_trc), d(orig.d)
{
