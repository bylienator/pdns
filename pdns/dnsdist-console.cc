...
const std::vector<ConsoleKeyword> g_consoleKeywords{
  ...
  { "SNMPTrapAction", true, "[reason]", "send a SNMP trap, adding the optional `reason` string as the query description"},
  { "SNMPTrapResponseAction", true, "[reason]", "send a SNMP trap, adding the optional `reason` string as the response description"},
